...
const pinyinToChar: Record<string, string> = {
  ...
  'zh': '知', 'ch': '吃', 'sh': '师', 'r': '日',
  'y': '衣', 'w': '乌',
  'ye': '耶', 'yue': '约', 'yuan': '圆', 'yin': '因', 'yun': '云', 'ying': '英',
}
...
const tonedChars: Record<string, Record<ToneType, string>> = {
  ...
  'ye': { 1: '耶', 2: '爷', 3: '也', 4: '叶', 0: '耶' },
  'yue': { 1: '约', 2: '月', 3: '越', 4: '阅', 0: '约' },
  'yuan': { 1: '鸳', 2: '圆', 3: '远', 4: '院', 0: '元' },
  'yin': { 1: '音', 2: '银', 3: '引', 4: '印', 0: '因' },
  'yun': { 1: '晕', 2: '云', 3: '允', 4: '运', 0: '云' },
  'ying': { 1: '英', 2: '赢', 3: '影', 4: '硬', 0: '鹰' },
  ...
  'ye': { 1: '耶', 2: '爷', 3: '也', 4: '夜', 0: '耶' },
  'yue': { 1: '约', 2: '月', 3: '月', 4: '月', 0: '约' },
  'yuan': { 1: '渊', 2: '圆', 3: '远', 4: '院', 0: '渊' },
  'yin': { 1: '因', 2: '银', 3: '引', 4: '印', 0: '因' },
  'yun': { 1: '晕', 2: '云', 3: '允', 4: '运', 0: '晕' },
  'ying': { 1: '英', 2: '营', 3: '影', 4: '硬', 0: '英' },
}
